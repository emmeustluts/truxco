const { Output: TourRevenueReportOutput } = require('../../dtos/TourRevenueReport.dto');

const request = require('supertest');

describe('GET https://api.beebus.live/reports/tour-revenue-report?lang=en', () => {
  it('should return status 200 and match expected structure', async () => {
    const res = await request('https://api.beebus.live')
      .get('/reports/tour-revenue-report?lang=en')
    ...
    expect(res.body).toMatchObject(TourRevenueReportOutput);
  });
});