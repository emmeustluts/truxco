const { Output: AgingReportOutput } = require('../../dtos/AgingReport.dto');

const request = require('supertest');

describe('GET https://api.beebus.live/reports/aging-report?lang=en', () => {
  it('should return status 200 and match expected structure', async () => {
    const res = await request('https://api.beebus.live')
      .get('/reports/aging-report?lang=en')
    ...
    expect(res.body).toMatchObject(AgingReportOutput);
  });
});