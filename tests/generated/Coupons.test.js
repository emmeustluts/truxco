const { Output: CouponsOutput } = require('../../dtos/Coupons.dto');

const request = require('supertest');

describe('GET https://api.beebus.live/client/coupons/2?lang=en', () => {
  it('should return status 200 and match expected structure', async () => {
    const res = await request('https://api.beebus.live')
      .get('/client/coupons/2?lang=en')
    ...
    expect(res.body).toMatchObject(CouponsOutput);
  });
});