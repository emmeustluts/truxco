const { Output: InvoiceCountReportOutput } = require('../../dtos/InvoiceCountReport.dto');

const request = require('supertest');

describe('GET https://api.beebus.live/finance/trip/invoice-count-report?lang=en', () => {
  it('should return status 200 and match expected structure', async () => {
    const res = await request('https://api.beebus.live')
      .get('/finance/trip/invoice-count-report?lang=en')
    ...
    expect(res.body).toMatchObject(InvoiceCountReportOutput);
  });
});