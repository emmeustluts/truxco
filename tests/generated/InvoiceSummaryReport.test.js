const { Output: InvoiceSummaryReportOutput } = require('../../dtos/InvoiceSummaryReport.dto');

const request = require('supertest');

describe('GET https://api.beebus.live/reports/invoice-summary-report?lang=en', () => {
  it('should return status 200 and match expected structure', async () => {
    const res = await request('https://api.beebus.live')
      .get('/reports/invoice-summary-report?lang=en')
    ...
    expect(res.body).toMatchObject(InvoiceSummaryReportOutput);
  });
});