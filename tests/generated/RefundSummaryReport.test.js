const { Output: RefundSummaryReportOutput } = require('../../dtos/RefundSummaryReport.dto');

const request = require('supertest');

describe('GET https://api.beebus.live/reports/refund-summary-report?lang=en', () => {
  it('should return status 200 and match expected structure', async () => {
    const res = await request('https://api.beebus.live')
      .get('/reports/refund-summary-report?lang=en')
    ...
    expect(res.body).toMatchObject(RefundSummaryReportOutput);
  });
});