const { Output: NotificationsOutput } = require('../../dtos/Notifications.dto');

const request = require('supertest');

describe('GET https://api.beebus.live/notifications?lang=en', () => {
  it('should return status 200 and match expected structure', async () => {
    ...
    expect(res.body).toMatchObject(NotificationsOutput);
  });
});