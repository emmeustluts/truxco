const { Output: InvoiceOutput } = require('../../dtos/Invoice.dto');

const request = require('supertest');

describe('GET https://api.beebus.live/finance/invoice?lang=en', () => {
  it('should return status 200 and match expected structure', async () => {
    const res = await request('https://api.beebus.live')
      .get('/finance/invoice?lang=en')
    ...
    expect(res.body).toMatchObject(InvoiceOutput);
  });
});