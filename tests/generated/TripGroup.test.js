const { Output: TripGroupOutput } = require('../../dtos/TripGroup.dto');

const request = require('supertest');

describe('GET https://api.beebus.live/booking-management/bookings/trip-group?lang=en', () => {
  it('should return status 200 and match expected structure', async () => {
    const res = await request('https://api.beebus.live')
      .get('/booking-management/bookings/trip-group?lang=en')
    ...
    expect(res.body).toMatchObject(TripGroupOutput);
  });
});