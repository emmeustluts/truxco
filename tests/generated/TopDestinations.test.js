const { Output: TopDestinationsOutput } = require('../../dtos/TopDestinations.dto');

const request = require('supertest');

describe('GET https://api.beebus.live/v1/admin/dashboard/top-destinations?lang=en', () => {
  it('should return status 200 and match expected structure', async () => {
    const res = await request('https://api.beebus.live')
      .get('/v1/admin/dashboard/top-destinations?lang=en')
    ...
    expect(res.body).toMatchObject(TopDestinationsOutput);
  });
});