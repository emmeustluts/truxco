const { Output: OptionsOutput } = require('../../dtos/Options.dto');

const request = require('supertest');

describe('GET https://api.beebus.live/v1/admin/trips/resources/drivers/options?lang=en', () => {
  it('should return status 200 and match expected structure', async () => {
    const res = await request('https://api.beebus.live')
      .get('/v1/admin/trips/resources/drivers/options?lang=en')
    ...
    expect(res.body).toMatchObject(OptionsOutput);
  });
});