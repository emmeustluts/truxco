const { Output: RefundsOutput } = require('../../dtos/Refunds.dto');

const request = require('supertest');

describe('GET https://api.beebus.live/v1/admin/finance/refunds?&lang=en', () => {
  it('should return status 200 and match expected structure', async () => {
    const res = await request('https://api.beebus.live')
      .get('/v1/admin/finance/refunds?lang=en')
    ...
    expect(res.body).toMatchObject(RefundsOutput);
  });
});